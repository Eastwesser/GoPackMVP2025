...
/*
	Фило — это филориал-птица, и у неё растут перья в зависимости от факториала своего размера.
	Нам нужно понять, сколько перьев она может причесать.
...
func main() {
	...
	fmt.Printf("При %d размере Фило может причесать %d своих пёрышек!!!\n", n, feathersRecursion)
	...
	fmt.Printf("При %d размере Фило может причесать %s своих пёрышек!!!\n", n, bigFiloRec.String())
