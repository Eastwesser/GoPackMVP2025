...
/*
	Абстракция: Интерфейс Character скрывает детали реализации.
	Композиция: Персонаж содержит оружие и артефакты.

	Инкапсуляция: Уровень персонажа скрыт, но доступен через метод.
	Наследование: PyroCharacter встраивает BaseCharacter.
	Полиморфизм: Разные персонажи могут использовать свои способности через общий интерфейс.
*/
